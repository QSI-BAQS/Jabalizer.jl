...
def build_circuit():
    ...
    # initialise qubits
    qubits = [cirq.GridQubit(i, 0) for i in range(7)]
    ...
    moments.append([X(qubits[4], qubits[5], qubits[6]).controlled_by(qubits[0], qubits[1], qubits[2], qubits[3])])
    ...
    moments.append([Z(qubits[3], qubits[4]).controlled_by(qubits[0], qubits[1], qubits[2])])
    moments.append([X(qubits[3]), X(qubits[2]), X(qubits[1]), X(qubits[0])])
    moments.append([H(qubits[0]), H(qubits[1]), H(qubits[2]), H(qubits[3])])
    moments.append([X(qubits[4])])
    moments.append([H(qubits[4])])
    moments.append([X(qubits[0]), X(qubits[2])])
    moments.append([X(qubits[4], qubits[6], qubits[5]).controlled_by(qubits[0], qubits[1], qubits[2], qubits[3])])
    moments.append([X(qubits[2]), X(qubits[0])])
    moments.append([H(qubits[4])])
    moments.append([X(qubits[4])])
    moments.append([H(qubits[3]), H(qubits[2]), H(qubits[1]), H(qubits[0])])
